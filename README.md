 ...
 ***
 ...
 Информационная система является важной так как[<sup>[1]</sup>](#sourse_1): <br/> 
...
К недостаткам ПТК ДЭГ относятся[<sup>[2]</sup>](#sourse_2):
...
К достоинствам ПТК ДЭГ относятся:
...
После на основе  USE CASE диаграммы создаетя диаграмма DFD (Data Flow Diagrams)[<sup>[4]</sup>](#sourse_4), которая наглядно отображает течение информации в системе (рисунок 2).
 <p align="center">
