...
[Список использованных источников](#Listofliterature)
...
В демократической системе управления государством, голосование проводится при выборах должностных лиц и при принятии решений , касающихся сообщества. Благодаря интерактивному голосованию можно облегчить систему выборов в целом, а также сэкономить главный человеческий ресурс-время.
 ...
 ## 2 Сравнительный анализ 
  ...
  Дистанционное электронное голосование(ДЭГ) - достаточно новая предвыборная технология в нашей стране. Одной из наиболее известных явлется Федеральная платформа для онлайн-голосования – программно-технического комплекса(ПТК) ДЭГ, разработанная «Ростелеком». Ее используют для автоматизации деятельности ресторана, бара. Первую версию создали в 1992 году, потом постепенно модернизировали. Сейчас ею пользуются больше 37 000 заведений.
  
К недостаткам ПТК ДЭК относится тот факт, что при онлайн голосовании у наблюдателей нет возможности проконтролировать кто голосует – сам избиратель или его родственник, работодатель или просто мошенник. Если на избирательном участке можно удостовериться, что избиратель голосует по своему паспорту и является тем, кто он есть, то обладателя «электронного» голоса идентифицировать фактически невозможно.

К достоинствам ПТК ДЭК относятся:
-Повышение электоральной явки;
-Повышение легитимности процедуры голосования. Технология блокчейн позволяет бороться с фальсификациями разного рода;
-Охрана здоровья людей во время эпидемий и пандемии;
